document.addEventListener('DOMContentLoaded', () => {
  ...
  if (listaAvaliacoesContainer && paginacaoAvaliacoes) {
    const avaliacoes = [
      ...
      },
      {
        ...
        foto: 'images/carlosalberto.svg',
        estrelas: '★★★★★',
        texto: 'Atendimento de primeira, cuidam muito bem dos animais e sempre explicam tudo com clareza.',
      },
      {
        nome: 'Adamilton Jr',
        foto: 'images/neymar.svg',
        estrelas: '★★★★★',
        texto: 'A clínica é muito bem equipada, e os profissionais são incríveis, mas o tempo de espera poderia ser menor.',
      },
      {
        nome: 'Luciana da Silva',
        foto: 'images/josseana.svg',
        estrelas: '★★★★★',
        texto: 'Profissionais capacitados e atenciosos, meu gato recebeu o melhor cuidado. Recomendo muito!',
      },
      {
        nome: 'Matheus Brito',
        foto: 'images/carlosalberto.svg',
        estrelas: '★★★★★',
        texto: 'A equipe é super dedicada e o ambiente é acolhedor, perfeito para quem se importa com o bem-estar do pet.',
      },
      {
        nome: 'Luiz Jr',
        foto: 'images/neymar.svg',
        estrelas: '★★★★★',
        texto: 'Atendimento excelente e muito atencioso! Meu pet recebeu todo o cuidado necessário e ficou ótimo.',
      },
      {
        nome: 'Clariane da Silva',
        foto: 'images/josseana.svg',
        estrelas: '★★★★★',
        texto: 'Fiquei satisfeita com o atendimento, mas achei os preços um pouco altos para alguns serviços.',
      },
    ];
    ...
    const btnAnterior = paginacaoAvaliacoes.querySelector('.botao-pagina-anterior');
    const btnProxima = paginacaoAvaliacoes.querySelector('.botao-pagina-proxima');
  ...
  if (
    carrosselImagem &&
    carrosselChevronEsquerda &&
    carrosselChevronDireita &&
